...
class Boilerplate_Catalog_Model_Observer {

	/**
	 * hide product inventory status element.
	 *
	 * @param Varien_Event_Observer $observer
	 *
	 * @return $this
	 */
	public function catalogBlockProductStatusDisplay( Varien_Event_Observer $observer ) {
		$observer->getStatus()->setDisplayStatus( false );
		return $this;
	}
}
