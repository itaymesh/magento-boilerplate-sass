...
class Boilerplate_Ajaxcart_Block_Confirmation_Removeproduct extends Boilerplate_Ajaxcart_Block_Confirmation_Abstract
{
    public function getContent($storeId = null)
    {
        if (is_null($this->_content)) {
            $this->_content = Mage::getStoreConfig('studioraz/ajaxcartpro/removeproductconfirmation/content', $storeId);
        }
