...
class Boilerplate_Ajaxcart_Block_Confirmation_Items_Continue extends Mage_Core_Block_Template
{
    protected function _toHtml()
    {
        $this->setTemplate('studioraz/ajaxcartpro/confirm/items/continue.phtml');
