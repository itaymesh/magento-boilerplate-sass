...
var ProductMediaManager = {
    ...
    createZoom: function(image) {
        ...
        if(
            // Condition I: Don't use zoom on devices where touch has been used
        // Condition II: Don't use zoom when screen is small, or else zoom window shows outside body
